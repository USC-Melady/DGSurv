...
class DeepExplainer(Explainer):
    ...
    def __init__(self, model, data, mask, session=None, learning_phase_flags=None):
        ...
        if framework == 'tensorflow':
            ...
            self.explainer = PyTorchDeep(model, data, mask)
    ...
    def shap_values(self, X, mask, ranked_outputs=None, output_rank_order='max', check_additivity=False):
        ...
        """
        return self.explainer.shap_values(X, mask, ranked_outputs, output_rank_order, check_additivity=check_additivity)
